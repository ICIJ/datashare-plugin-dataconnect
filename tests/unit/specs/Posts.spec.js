...
describe('Posts.vue', () => {
  ...
  describe('When Posts creates a comment', () => {
    describe('Determining the Category in which to locate the Topic, where the comment will be stored', () => {
      ...
      describe('setCategory() - combines both getCategory() and createCategory(), only creating a category if it does not exist already', () => {
    ...
    describe('Determining the topic in which to make the comment', () => {
